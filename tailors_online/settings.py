"""
Django settings for tailors_online project.
...
ALLOWED_HOSTS = ['localhost', '.tailorsonline.tech', '.vercel.app', '.now.sh']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.skcytzfczcvbtblhhpbu',
        'PASSWORD': 'qTQfM6R9$W2MYpD',
